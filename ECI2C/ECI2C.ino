...
#define address 0x64              //default I2C ID number for EZO EC Circuit.
...
void setup()                    //hardware initialization.
{
  ...
  Wire.begin();                 //enable I2C port.Wire.beginTransmission(address);                                              //call the circuit by its ID number.
}
